...
let xorS,  reverb1, reverb2 = ReverbSchroeder.create(15,xorS);
function initReverb(){
    xorS = new XorShift(constParams.reverbSeed)
...
for(let i=0;i<numTrack;i++){
    ...
    mixer.setTrack(i,panScatter(i,7,0.9),0.6, 0.3);
    // mixer.setTrack(i,panScatter(i,8,1),0.1, 0.9);
}
